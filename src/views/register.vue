	...
	<div>
		...
		<el-form status-icon ref="ruleForm" label-width="100px" class="login-container">
			<el-form-item label="用户名" prop="pass">
				<el-input type="text" v-model="userName" autocomplete="off" placeholder="请输入帐号"></el-input>
			</el-form-item>
			<el-form-item label="密码" prop="checkPass" >
				<el-input type="text"  v-model="userPwd" autocomplete="off" placeholder="请输入密码"></el-input>
			</el-form-item>
			<el-form-item>
