<template>
	<div>
		...
		<el-breadcrumb separator=">" style="margin-top: 20px;margin-left: 20px;">
			<el-breadcrumb-item><a style="font-size: 20px;">客户服务分析</a></el-breadcrumb-item>
		</el-breadcrumb>
			...
			<div style="margin: 20px;margin-top:80px;">
				...
				<el-table :data="result" style="width: 100%;" :border="true" max-height="650">
					...
					<el-table-column prop="type" label="等级" min-width="80"></el-table-column>
...
<script>
	export default {
		...
		methods: {
			/* 查询 */
			doSearch: function() {
				let url = this.axios.urls.STATISTICS_MANAGE_CUSTOMER_SERVICE;
