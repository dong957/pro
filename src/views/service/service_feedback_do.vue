<template>
	<div>
		...
		<el-breadcrumb separator=">" style="margin-top: 20px;margin-left: 20px;">
			<el-breadcrumb-item><a  href="#/service_feedback" style="font-size: 20px;" >客户服务管理 </a></el-breadcrumb-item>
			<el-breadcrumb-item><a style="font-size: 20px;">服务反馈</a></el-breadcrumb-item>
			
		</el-breadcrumb>
			
		<div style="width: 1580px;">
			<div style="margin-left: 900px;margin-bottom: 10px;">
				<el-button @click="feedback" style="margin-top;">保存</el-button>
			</div>
			<el-form :inline="true" style="margin-top: 10px;">
				...
				<el-form-item label="处理结果" :label-width="formLabelWidth" style="background-color: cornsilk;">
					<el-input   v-model="svrResult" autocomplete="off" :style="{width: formEleWidth}"></el-input>
				</el-form-item>
				<el-form-item label="满意度" :label-width="formLabelWidth" style="background-color: cornsilk;">
					<div  style="background-color: white;height: 40px;" >
						<div style="height: 10px;">&nbsp;</div>
						 <el-rate v-model="svrSatisfy" style="width:300px;"   show-text ></el-rate>
					</div>
				</el-form-item>
